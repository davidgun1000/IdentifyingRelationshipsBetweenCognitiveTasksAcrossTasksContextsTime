...
adapt=5000;
nit=20000; % we take the last 10000 draws out of 12000 draws
...
while i<=s
   ...
   [theta_latent]=LBA_CMC_v2_matchstopsearch(data,param,theta_latent,num_subjects,num_trials,num_particles,mean_theta,covmat_theta,i,burn,adapt);
    ...
    %save the output to your directory
     ...
     if mod(i,1000)==0
        save('/short/jz21/dg2271/LBA_matchsearchstop_covariance_popOut3.mat','theta_mu_store','theta_sig2_store1','theta_sig2_store2','theta_sig2_store3','theta_sig2_store4',...
